...
/**
 * Main - building a simple shell with Obed
 *
 * Description: the program displays a prompt
 * gets input from user
 * splits the input input into null terminated strings
 * count the number of times it did that
 * and prints the splitted string into standard output
 * Return: 0, success
 */
int main(void)
{
